...
def attack(char_name: str, char_class: str) -> str:
    ...
    Возвращает строку о нанесённом персонажем уроне
...
def defence(char_name: str, char_class: str) -> str:
    """
    Принимает на вход имя и класс персонажа.
    Возвращает строку о блокированном персонажем уроне
    в зависимости от его класса.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Принимает на вход имя и класс персонажа.
    Возвращает строку о задействованной персонажем
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Принимает на вход имя и класс персонажа.
    Возвращает результат цикла тренировки персонажа.
    """
    if char_class == 'warrior':
